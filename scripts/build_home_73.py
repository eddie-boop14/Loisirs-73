...
HUBS = {
    ...
    "bases-de-loisirs": {"cats": ("domaine", "parc"),
                      "label": {"fr": "Bases de loisirs", "en": "Leisure parks", "de": "Freizeitparks",
                                "it": "Aree ricreative", "es": "Áreas de ocio", "nl": "Recreatieparken"}},
    ...
    "stations-de-ski": {"cats": ("station",),
                      "label": {"fr": "Stations de ski", "en": "Ski resorts", "de": "Skigebiete",
                                "it": "Stazioni sciistiche", "es": "Estaciones de esquí", "nl": "Skigebieden"}},
    "musees":        {"cats": ("musee",),
...
GROUPS = [
    ({"fr": "Nature & grand air", "en": "Nature & the outdoors", "de": "Natur & frische Luft",
     ...
     ["lacs-plages", "cascades", "points-de-vue", "sentiers", "telecabines", "voies-vertes", "bases-de-loisirs"]),
    ({"fr": "Neige & hiver", "en": "Snow & winter", "de": "Schnee & Winter",
      "it": "Neve & inverno", "es": "Nieve & invierno", "nl": "Sneeuw & winter"},
     ["stations-de-ski"]),
...
BANDS = [
    ...
    ({"fr": "Neige & hiver", "en": "Snow & winter", "de": "Schnee & Winter",
      "it": "Neve & inverno", "es": "Nieve & invierno", "nl": "Sneeuw & winter"},
     {"fr": "Des 3 Vallées à la Haute-Maurienne : les stations de ski de la Savoie, vérifiées une par une.",
      "en": "From the 3 Vallées to the Haute-Maurienne: Savoie's ski resorts, verified one by one.",
      "de": "Von den 3 Vallées bis zur Haute-Maurienne: die Skigebiete der Savoie, einzeln geprüft.",
      "it": "Dalle 3 Vallées all'Alta Maurienne: le stazioni sciistiche della Savoie, verificate una per una.",
      "es": "De los 3 Vallées a la Alta Maurienne: las estaciones de esquí de la Savoie, verificadas una a una.",
      "nl": "Van de 3 Vallées tot de Haute-Maurienne: de skigebieden van Savoie, stuk voor stuk getoetst."},
     ["stations-de-ski"]),
    ({"fr": "Patrimoine & culture", "en": "Heritage & culture", "de": "Erbe & Kultur",
      "it": "Patrimonio & cultura", "es": "Patrimonio & cultura", "nl": "Erfgoed & cultuur"},
